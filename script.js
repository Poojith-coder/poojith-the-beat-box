...
if (key == 65) {
    ...
    document.getElementById('65').style.boxShadow = "0px 0px 40px 0px aqua"
    setTimeout(function() {
    ...
    document.getElementById('83').style.boxShadow = "0px 0px 40px 0px aqua"
    setTimeout(function() {
    ...
    document.getElementById('68').style.boxShadow = "0px 0px 40px 0px aqua"
    setTimeout(function() {
    ...
    document.getElementById('70').style.boxShadow = "0px 0px 40px 0px purple"
    setTimeout(function() {
    ...
    document.getElementById('71').style.boxShadow = "0px 0px 40px 0px purple"
    setTimeout(function() {
    ...
    document.getElementById('72').style.boxShadow = "0px 0px 40px 0px purple"
    setTimeout(function() {
    ...
    audio.currentTime = 0;
    audio.play();
    document.getElementById('74').style.backgroundColor = "red";
    document.getElementById('74').style.boxShadow = "0px 0px 40px 0px red"
    setTimeout(function() {
    ...
    document.getElementById('75').style.boxShadow = "0px 0px 40px 0px white"
    setTimeout(function() {
    ...
    document.getElementById('76').style.boxShadow = "0px 0px 40px 0px white"
    setTimeout(function() {
